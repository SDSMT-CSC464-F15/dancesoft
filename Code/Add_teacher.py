...
class Ui_add_teacher(object):
    def setupUi(self, add_teacher):
        ...
        self.formLayout.setWidget(9, QtGui.QFormLayout.LabelRole, self.genderLabel)
        ...
        self.formLayout.setWidget(11, QtGui.QFormLayout.FieldRole, self.payRateDoubleSpinBox)
        ...
        self.dateEdit.setDateTime(QtCore.QDateTime(QtCore.QDate(1970, 1, 1), QtCore.QTime(0, 0, 0)))
