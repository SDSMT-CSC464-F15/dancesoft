...
class Ui_change_password(object):
    def setupUi(self, change_password):
        ...
        change_password.resize(423, 206)
        ...
        self.passwordLabel.setGeometry(QtCore.QRect(10, 70, 81, 16))
        ...
        self.passwordLineEdit.setGeometry(QtCore.QRect(100, 70, 271, 20))
    ...
    def retranslateUi(self, change_password):
        ...
        self.passwordLabel.setText(_translate("change_password", "New Password", None))
