...
class Ui_stu_info_dialog(object):
    def setupUi(self, stu_info_dialog):
        ...
        self.Cphone_detail_label = QtGui.QLabel(stu_info_dialog)
        ...
        self.Cphone_detail_lineEdit = QtGui.QLineEdit(stu_info_dialog)
        ...
        self.Sguardian_detail_comboBox = QtGui.QComboBox(stu_info_dialog)
        ...
        self.Pguradian_detail_comboBox = QtGui.QComboBox(stu_info_dialog)
    ...
    def retranslateUi(self, stu_info_dialog):
        ...
        self.Phone_detail_label.setText(_translate("stu_info_dialog", "Home Phone", None))
        ...
        self.State_detail_ComboBox.setItemText(0, _translate("stu_info_dialog", "Alabama", None))
        self.State_detail_ComboBox.setItemText(1, _translate("stu_info_dialog", "Alaska", None))
        self.State_detail_ComboBox.setItemText(2, _translate("stu_info_dialog", "Arizona", None))
        self.State_detail_ComboBox.setItemText(3, _translate("stu_info_dialog", "Arkansas", None))
        self.State_detail_ComboBox.setItemText(4, _translate("stu_info_dialog", "California", None))
        self.State_detail_ComboBox.setItemText(5, _translate("stu_info_dialog", "Colorado", None))
        self.State_detail_ComboBox.setItemText(6, _translate("stu_info_dialog", "Connecticut", None))
        self.State_detail_ComboBox.setItemText(7, _translate("stu_info_dialog", "Delaware", None))
        self.State_detail_ComboBox.setItemText(8, _translate("stu_info_dialog", "Florida", None))
        self.State_detail_ComboBox.setItemText(9, _translate("stu_info_dialog", "Georgia", None))
        self.State_detail_ComboBox.setItemText(10, _translate("stu_info_dialog", "Hawaii", None))
        self.State_detail_ComboBox.setItemText(11, _translate("stu_info_dialog", "Idaho", None))
        self.State_detail_ComboBox.setItemText(12, _translate("stu_info_dialog", "Illinois", None))
        self.State_detail_ComboBox.setItemText(13, _translate("stu_info_dialog", "Indiana", None))
        self.State_detail_ComboBox.setItemText(14, _translate("stu_info_dialog", "Iowa", None))
        self.State_detail_ComboBox.setItemText(15, _translate("stu_info_dialog", "Kansas", None))
        self.State_detail_ComboBox.setItemText(16, _translate("stu_info_dialog", "Kentucky", None))
        self.State_detail_ComboBox.setItemText(17, _translate("stu_info_dialog", "Louisiana", None))
        self.State_detail_ComboBox.setItemText(18, _translate("stu_info_dialog", "Maine", None))
        self.State_detail_ComboBox.setItemText(19, _translate("stu_info_dialog", "Maryland", None))
        self.State_detail_ComboBox.setItemText(20, _translate("stu_info_dialog", "Massachusetts", None))
        self.State_detail_ComboBox.setItemText(21, _translate("stu_info_dialog", "Michigan", None))
        self.State_detail_ComboBox.setItemText(22, _translate("stu_info_dialog", "Minnesota", None))
        self.State_detail_ComboBox.setItemText(23, _translate("stu_info_dialog", "Mississippi", None))
        self.State_detail_ComboBox.setItemText(24, _translate("stu_info_dialog", "Missouri", None))
        self.State_detail_ComboBox.setItemText(25, _translate("stu_info_dialog", "Montana", None))
        self.State_detail_ComboBox.setItemText(26, _translate("stu_info_dialog", "Nebraska", None))
        self.State_detail_ComboBox.setItemText(27, _translate("stu_info_dialog", "Nevada", None))
        self.State_detail_ComboBox.setItemText(28, _translate("stu_info_dialog", "New Hampshire", None))
        self.State_detail_ComboBox.setItemText(29, _translate("stu_info_dialog", "New Jersey", None))
        self.State_detail_ComboBox.setItemText(30, _translate("stu_info_dialog", "New Mexico", None))
        self.State_detail_ComboBox.setItemText(31, _translate("stu_info_dialog", "New York", None))
        self.State_detail_ComboBox.setItemText(32, _translate("stu_info_dialog", "North Carolina", None))
        self.State_detail_ComboBox.setItemText(33, _translate("stu_info_dialog", "North Dakota", None))
        self.State_detail_ComboBox.setItemText(34, _translate("stu_info_dialog", "Ohio", None))
        self.State_detail_ComboBox.setItemText(35, _translate("stu_info_dialog", "Oklahoma", None))
        self.State_detail_ComboBox.setItemText(36, _translate("stu_info_dialog", "Oregon", None))
        self.State_detail_ComboBox.setItemText(37, _translate("stu_info_dialog", "Pennsylvania", None))
        self.State_detail_ComboBox.setItemText(38, _translate("stu_info_dialog", "Rhode Island", None))
        self.State_detail_ComboBox.setItemText(39, _translate("stu_info_dialog", "South Carolina", None))
        self.State_detail_ComboBox.setItemText(40, _translate("stu_info_dialog", "South Dakota", None))
        self.State_detail_ComboBox.setItemText(41, _translate("stu_info_dialog", "Tennessee", None))
        self.State_detail_ComboBox.setItemText(42, _translate("stu_info_dialog", "Texas", None))
        self.State_detail_ComboBox.setItemText(43, _translate("stu_info_dialog", "Utah", None))
        self.State_detail_ComboBox.setItemText(44, _translate("stu_info_dialog", "Vermont", None))
        self.State_detail_ComboBox.setItemText(45, _translate("stu_info_dialog", "Virginia", None))
        self.State_detail_ComboBox.setItemText(46, _translate("stu_info_dialog", "Washington", None))
        ...
        self.Cphone_detail_label.setText(_translate("stu_info_dialog", "Cell Phone", None))
