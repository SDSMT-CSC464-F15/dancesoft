...
The teacher removal removes from the Teacher table, the Teacher_Class, Address, Teacher_Payrate, Account, and the admin table if needed. The class removal removes from the Class, Student_Class, and the Teacher_Class. The student removal removes from the Student, Student_Class, Address, Guardian, and billing tables. Lastly the admin removal removes either admin permissions or admin from the system.
