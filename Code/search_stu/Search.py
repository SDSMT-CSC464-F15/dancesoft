...
class Ui_Search_MainWindow(object):
    def setupUi(self, Search_MainWindow):
        ...
        self.Search_lineEdit.setGeometry(QtCore.QRect(210, 60, 221, 21))
        ...
        self.Adv_search_btn.setGeometry(QtCore.QRect(550, 60, 131, 23))
        ...
        self.Exact_search_cbox.setGeometry(QtCore.QRect(140, 50, 71, 41))
