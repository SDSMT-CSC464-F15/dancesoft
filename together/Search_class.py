...
class Ui_Search_MainWindow(object):
    def setupUi(self, Search_MainWindow):
        ...
        self.Class_view.setObjectName(_fromUtf8("Class_view"))
    ...
    def retranslateUi(self, Search_MainWindow):
        Search_MainWindow.setWindowTitle(_translate("Search_MainWindow", "Class Search", None))
        self.label.setText(_translate("Search_MainWindow", "Enter Class Name", None))
